...
import { listenToPlayers_DB, setPhase_DB, listenToRound_DB, listenToStage_DB, getNumRounds_DB, getRoomHost_DB, getUsedImages_DB, setRoundImage_DB, addToUsedImages_DB, listenToRoundImage_DB, listenToPlayerParameters_DB, getPlayerPoints_DB } from '@/utils/firebaseUtils'
...
export default function GamePage() {
  ...
  // Cuando cambiamos de round, getPlayerPoints_DB y actualizamos points
  useEffect(() => {
    if (!roomToken) return
